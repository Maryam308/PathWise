// ─────────────────────────────────────────────────────────────────────────────
// pages/DashboardPage.jsx   (the "Home" page for authenticated users)
//
// "View all transactions" in the Recent Transactions section navigates to
// /profile with the card tab pre-selected (?tab=card so ProfilePage can read it)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Compact transaction row for dashboard preview
// ─────────────────────────────────────────────────────────────────────────────
...
const DashboardPage = () => {
  ...
  // Load only the 4 most recent for the preview
  useEffect(() => {
              ...
              <div className="relative flex items-center justify-end min-h-[200px]">
                ...
                <div className="relative z-10 mr-4 mt-4" style={{ height: "140px", width: "210px" }}>
                  {[
                    ...
                    <div key={i} className={`absolute w-52 h-32 rounded-2xl ${c.bg} flex items-center justify-end px-5`}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex gap-2">
                {/* "View all" → profile card tab with transactions */}
                <Link to="/profile?tab=card"
